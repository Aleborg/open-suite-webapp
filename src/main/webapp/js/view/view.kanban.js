...
(function() {
    ...
    ui.directive('uiKanban', function() {
        return {
            replace: true,
            template: "<div class='kanban-view row' ng-clsss='::schema.css'>" +
    ...
    ui.directive('uiCards', function() {
        return {
            ...
            replace: true,
            template: "<div class='cards-view row' ng-class='::schema.css'>" +
    ...
    angular.module('axelor.ui').directive('uiPortletCards', function() {
        return {
            ...
            template: "<div class='portlet-cards' ui-portlet-refresh>" +
                "<div ui-cards></div>" +
                "</div>"
        };
    });
    ...
    angular.module('axelor.ui').directive('uiPortletKanban', function() {
        return {
            ...
            replace: true,
            link: linker,
            template: "<div class='portlet-kanban' ui-portlet-refresh>" +
                "<div ui-kanban></div>" +
                "</div>"
        };
    });
