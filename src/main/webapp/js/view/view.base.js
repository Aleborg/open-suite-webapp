...
(function() {
    ...
    ui.directive('uiViewPane', function() {
        ...
        return {
            ...
            template: "<div class='view-pane' ui-attach='keepAttached || tab.selected'>" +
    ...
    ui.directive('uiViewPopup', function() {
        ...
        return {
            ...
            replace: true,
            template: '<div ui-dialog ui-dialog-size x-resizable="true" x-on-close="onPopupClose" x-on-ok="onPopupOK" x-on-before-close="onBeforeClose">' +
    ...
    ui.directive('uiRecordPager', function() {
        ...
        return {
            ...
            template: '<div class="record-pager hidden-xs">' +
                '<span ng-show="showText">' +
                '<span class="record-pager-text">{{pagerText()}}</span>' +
                '<span class="input-group record-pager-change">' +
                '<input type="text" style="width: 30px;" value="{{getPageSize()}}">' +
                '<button type="button" class="btn input-group-addon"><i class="fa fa-check"></i></button>' +
                '</span>' +
                '</span>' +
                '<div class="btn-group">' +
    ...
    ui.directive('uiViewCustomize', ['NavService', function(NavService) {
        ...
        return {
            ...
            replace: true,
            template: "<ul ng-show='canShow()' class='nav menu-bar view-customize hidden-xs'>" +
    ...
    ui.directive('uiViewSwitcher', function() {
        return {
            ...
            replace: true,
            template: '<div class="view-switcher pull-right hidden-xs">' +
                '<div class="btn-group">' +
    ...
    ui.directive('uiViewSwitcherMenu', function() {
        return {
            ...
            replace: true,
            template: "<span class='view-switch-menu dropdown pull-right'>" +
