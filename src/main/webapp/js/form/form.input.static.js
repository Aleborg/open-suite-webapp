...
(function() {
        ...
        return {
            link: function(scope, element) {
                ...
                function showPopup(data) {
                    ...
                    // add value fields
                    $("<div class='row'>")
                        .append($("<label class='col-md-12'>").text(_t("Value")))
                        .appendTo(form);
                    $("<div class='row'>")
                        .append(valueInput)
                        .appendTo(form);
                    ...
                    $("<div class='row'>")
                        .append($("<label class='col-md-8'>").text(_t("Translation")))
                        .append($("<label class='col-md-4'>").text(_t("Language")))
                        .appendTo(form);
                    ...
                    function addRow(item) {
                        ...
                        var input1 = (scope.field.multiline ?
                            ...
                            .val(item.message)
                            .on("input", onchange);
                        var input2 = $("<input type='text' class='col-md-4'>")
                            .prop("name", "language")
                            .prop("required", true)
                            .val(item.language)
                            .on("input", onchange);
    ...
    ui.formItem('GridButton', 'Button', {
        template: "<a href='' class='form-item-container'>" +
            "<span class='btn-text' ng-transclude></span>" +
            "</a>"
    });
    ...
    ui.formItem('InfoButton', 'Button', {
        ...
        replace: true,
        template: "<div class='btn info-button'>" +
    ...
    ui.formItem('ToolButton', 'Button', {
        ...
        template: '<button class="btn" ui-show="!isHidden()" name="{{btn.name}}" ui-actions ui-widget-states>' +
