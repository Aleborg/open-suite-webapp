...
(function() {
    ...
    ui.formInput('Boolean', {
        ...
        template_editable: "<label class='ibox'>" +
    ...
    ui.formInput('Toggle', 'Boolean', {
        ...
        template_readonly: null,
        template_editable: "<button tabindex='-1' class='btn btn-default' ng-class='{active: $value}' ng-click='toggle()'>" +
            "<i class='fa {{icon()}}'></i>" +
            "</button>"
    });
    ...
    ui.formInput('BooleanSwitch', 'Boolean', {
        ...
        metaWidget: true,
        template_readonly: null,
        template_editable: "<label class='iswitch'>" +
            "<input type='checkbox' ng-model='$value' ng-disabled='isReadonly()'>" +
            "<span class='box'></span>" +
            "</label>"
    });
