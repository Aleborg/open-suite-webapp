...
(function() {
    ...
    ui.formWidget('uiMailMessages', {
        ...
        template: "<div class='mail-messages panel panel-default col-md-9' ng-class='animation'>" +
    ...
    ui.formWidget('uiMailComposer', {
        ...
        template: "" +
            ...
            "<textarea rows='1' ng-model='post' ui-textarea-auto-size class='col-md-12' placeholder='{{\"Write your comment here\" | t}}'></textarea>" +
    ...
    ui.formWidget('uiMailFollowers', {
        ...
        template_readonly: null,
        template_editable: null,
        template: "<div class='mail-followers panel panel-default col-md-3'>" +
    ...
    ui.formWidget('PanelMail', {
        ...
        link: function(scope, element, attrs) {
            ...
            if (field.items && field.items.length === 1) {
                setTimeout(function() {
                    element.children('.mail-messages').removeClass('col-md-9').addClass('col-md-12');
                    element.children('.mail-followers').removeClass('col-md-3').addClass('col-md-12');
                });
            }
        },
        transclude: true,
        template_readonly: null,
        template_editable: null,
        template: "<div class='form-mail row' ng-show='record.id > 0 || folder' ui-transclude></div>"
    });
