...
(function() {
        ...
        return {
            ...
            link: function(scope, element, attrs, form) {
                ...
                scope.canShowTags = function() {
                    ...
                    return scope.filter && ['many-to-one', 'one-to-one', 'many-to-many'].indexOf(scope.filter.type) > -1 &&
            ...
            template: "<div class='flex-layout'>" +
                "<div class='flex-row'>" +
    ...
    ui.directive('uiFilterContext', function() {
        ...
        return {
            ...
            template: "<div class='flex-layout filter-context' ng-show='contextFields.length'>" +
                "<div class='flex-row'>" +
                "<div class='flex-item filter-remove'>" +
